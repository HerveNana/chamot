...
<head>
  ...
  <meta charset="UTF-8">
  <title><?php echo isset($title) ? $title : "Universite de Guyane"; ?></title>
            ...
            <div class="panel-heading">
              <div class="row">
                <div class="col-xs-6 tabs">
                  <button name="loginknown" class="active" id="login-form-link">
                    <div class="login">Je connais mon mot de passe et je le modifie</div>
                  </button>

                </div>
                <div class="col-xs-6 tabs">
                  <button name="loginasked" id="register-form-link">
                    <div class="login">Je demande un mot de passe provisoire </div>
                  </button>
                </div>
              </div>
            </div>
