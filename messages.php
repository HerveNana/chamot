...
$messages['nocorrectinfo'] = "Les informations que vous venez de renseigner ne correspondent pas à celles connues de l'administration. Veuillez les modifer, ou vous rapprocher de la scolarité si vous êtes étudiant, des ressourcess humaines dans les autres cas."; 
$messages['noldapserver'] = "Il est impossible de se connecter au serveur veuillez contacter le service informatique";
$messages['bindnotavailable'] = "connection au référentiel impossible. veuillez contacter le service informatique";
