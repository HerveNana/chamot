...
$messages['confirmpassword'] = "Confirmation de votre mot de passe";
...
$messages['nocorrectinfo'] = "Les informations que vous venez de renseigner (nom, prénoms, email) ne correspondent pas à celles connues de l'administration. Veuillez les modifer, ou vous rapprocher de la scolarité si vous êtes étudiant, des ressources humaines dans les autres cas.";
$messages['no correctuser'] = "la combinaison nom(s) et prénom(s) que vous avez renseigné(s)e";
$messages['noadserver'] = "Il est impossible de se connecter au serveur Windows! Veuillez contacter le service informatique";
$messages['noldapserver'] = "Il est impossible de se connecter au serveur! Veuillez contacter le service informatique";
$messages['bindnotavailable'] = "connection au serveur windows impossible! Veuillez contacter le service informatique";
...
$messages['wrongOldPassword'] = "Le mot de passe actuel que vous venez de renseigner est incorrect.";
$messages['passwordreset'] = "Votre mot de passe à été modifié";
$messages['failtosendtemporarypassword'] = "Votre mot de passe provisoire n'a pas pu vous être envoyé. Veuillez recommencer ou contacter le service informartique.";
$messages['senttemporarypassword'] = "Un mot de passe provisoire à été envoyé à votre adresse mail personnelle, veuillez consulté votre mail prsonnel pour le récupérer";
$messages['noConfAffiliate'] = "Vous ne disposez pas d'un compte vacataire. Veuillez sélectionner une autre catégorie.";
$messages['noConfEmployee'] = "Vous ne disposez pas d'un compte employé. Veuillez sélectionner une autre catégorie.";
$messages['noConfStudent'] = "Vous ne disposez pas d'un compte étudiant. Veuillez sélectionner une autre catégorie.";
$messages['noExistingLogin'] = "Le login que vous avez renseigné ne correspond à aucun compte utilisateur connu. Veuillez vérifier vos informations."
?>